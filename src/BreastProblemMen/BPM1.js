      ...
      <section>
        <div className='box'>
          ...
          <Form.Group className='mb-3' controlId='formBasicAge'>
            <Form.Label>
              Do you have swelling under and/or around one or both nipples, and
              are you between the ages of 10 and 25?
            </Form.Label>
            <br />
            <button
              type='submit'
          ...
          <Button variant='success' type='submit' style={{ width: '100%' }}>
            <Link to='/BPM2' style={{ textDecoration: 'none', color: 'white' }}>
              NEXT QUESTION
            </Link>
          </Button>
        </div>
